                        ...
                        <div class="relative p-4 w-full max-w-sm max-h-[calc(100vh-5rem)]"> <!-- Adjust modal max height -->
                            ...
                            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 overflow-y-auto">
                                ...
                                <div class="flex items-center p-3 border-t border-gray-200 rounded-b dark:border-gray-600">
                                    <button data-modal-hide="default-modal" type="button" class="text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-xs px-4 py-2 text-center dark:bg-orange-600 dark:hover:bg-orange-600 dark:focus:ring-orange-500">Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
