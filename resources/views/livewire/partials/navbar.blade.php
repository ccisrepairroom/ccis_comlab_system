          ...
          @endguest
           ...
           <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] [--trigger:click] md:py-4">
            ...
            @if(in_array(auth()->user()->role_id, [1, 2, 3]))
              <a href="{{ url('ccis_erma/management') }}" class="cursor-pointer flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-orange-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" >
                My Dashboard
              </a>
              @endif
